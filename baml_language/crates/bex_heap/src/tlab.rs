...
impl Tlab {
    ...
    #[inline]
    pub fn alloc_type(&mut self, ty: bex_vm_types::RealizedTy) -> HeapPtr {
...
pub trait TlabHolder {
    ...
    fn alloc_type(&mut self, ty: bex_vm_types::RealizedTy) -> HeapPtr {
        ...
        let class_ptr = tlab.alloc(Object::Class(Box::new(Class {
            ...
            fields: vec![
                bex_vm_types::ClassField {
                    ...
                    field_template: bex_vm_types::TyTemplate::from(bex_vm_types::RealizedTy::Int {
                        attr: baml_type::TyAttr::default(),
                    }),
                    description: None,
                    alias: None,
